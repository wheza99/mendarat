...
// Using a custom ChevronDownIcon
    ...
    <section className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          ...
          style={{ 
            backgroundImage: `url(https://images.unsplash.com/photo-1518709268805-4e9042af2176?q=80&w=2025&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)` 
          }}
        />
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center text-white">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-wider mb-2 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500">
            CYBER <span className="text-white">BUSINESS</span>
          </h1>
          <p className="text-xl md:text-2xl font-light tracking-wide text-pink-200 mt-2">
            Solusi digital untuk masa depan bisnis Anda
          </p>
        </motion.div>
        ...
        >
          Kami menghadirkan teknologi terdepan dengan estetika retro-futuristik untuk mentransformasi bisnis Anda ke era digital yang penuh inovasi dan kreativitas.
        </motion.p>
