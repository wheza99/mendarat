...
export default function DesertHero() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 py-20 relative">
      {/* Desert reflection effect */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-amber-800/20 to-transparent animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-amber-200 max-w-3xl mx-auto mb-12 leading-relaxed font-serif">
          Discover the ancient secrets and mystical wonders of the Arabian desert.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center group">
            <div className="text-4xl font-bold text-amber-400 mb-2 group-hover:text-amber-300 transition-colors">1000+</div>
            <div className="text-amber-200">Desert Miles</div>
            <div className="w-16 h-1 bg-amber-400 mx-auto mt-2 group-hover:bg-amber-300 transition-colors"></div>
          </div>
          <div className="text-center group">
            <div className="text-4xl font-bold text-orange-400 mb-2 group-hover:text-orange-300 transition-colors">500+</div>
            <div className="text-amber-200">Years History</div>
          ...
          <div className="text-center group">
            ...
            <div className="text-amber-200">Desert Magic</div>
