  ...
  const services = [
    {
      ...
      features: ["Geometric Patterns", "Neon Gradients", "Typography", "Animations"],
      color: "purple"
    },
    {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-pink-300 max-w-3xl mx-auto font-light">
            Professional services that blend Art Deco sophistication with neon gradient innovation
          </p>
        </div>
