      ...
      <div className="absolute inset-0 opacity-10">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            >
              <path
                d="M0 50 L40 50 L40 0"
                fill="none"
                stroke="#06b6d4"
                strokeWidth="0.5"
              />
              <path
                d="M50 0 L50 40 L100 40"
                fill="none"
                stroke="#06b6d4"
                strokeWidth="0.5"
              />
              ...
              />
              <path
                d="M50 100 L50 70 L0 70"
                fill="none"
                stroke="#06b6d4"
                strokeWidth="0.5"
              />
              <circle cx="40" cy="50" r="2" fill="#06b6d4" />
              <circle cx="50" cy="40" r="2" fill="#06b6d4" />
              <circle cx="60" cy="60" r="2" fill="#06b6d4" />
              <circle cx="50" cy="70" r="2" fill="#06b6d4" />
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#digital-circuit)" />
        </svg>
      </div>
    );
  };
  ...
  return (
    <section id="team" className="relative py-24 bg-gray-900 overflow-hidden">
      ...
      <div className="container mx-auto px-4" ref={containerRef}>
        ...
        {/* Team members grid with holographic card effect */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamSectionCopy.teamMembers.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              {/* Holographic card with 3D effect */}
              <motion.div
                whileHover={{
                  rotateY: 5,
                  rotateX: -5,
                ...
                className="relative rounded-lg overflow-hidden bg-gradient-to-br from-gray-800/80 to-gray-900/90 border border-cyan-500/30 transform perspective-1000"
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden">
                  ...
                  {/* Digital scan effect */}
                  <motion.div
                    className="absolute inset-x-0 h-1 bg-gradient-to-r from-transparent via-cyan-400 to-transparent opacity-0 group-hover:opacity-100"
                    animate={{
                      top: ["0%", "100%", "0%"],
                    }}
                    transition={{
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 flex justify-center space-x-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    {teamSectionCopy.socialLinks.map((social, i) => (
                      <motion.a
                        key={i}
                        href="#"
                        whileHover={{ scale: 1.2, y: -5 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-8 h-8 rounded-full bg-gray-800/80 backdrop-blur-sm border border-cyan-500/30 flex items-center justify-center text-cyan-400 hover:text-white hover:bg-cyan-500 transition-colors"
                      >
                        {social === "github" && (
                ...
                <div className="p-6">
                  ...
                  <p className="text-cyan-400 text-sm font-mono tracking-wide mb-4">
                    {member.role}
                  </p>
                  <div className="relative">
                    <div className="absolute -left-2 top-0 w-1 h-full bg-gradient-to-b from-cyan-400 to-blue-600" />
