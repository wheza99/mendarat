  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-black px-4 sm:px-6 lg:px-8">
      ...
      <div 
        ...
        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1527576539890-dfa815648363?q=80&w=3465&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}
      />
        ...
        <div className="absolute top-1/2 transform -translate-y-1/2 text-white">
          <div className="max-w-xl">
            ...
            <p className="text-sm md:text-base max-w-xl mb-10 text-gray-300">
              For every distinct life-event presentation, be from the countries Yakutia and Concordia, there live the finest texts.
            </p>
            <div>
