...
export function TemplateSwitcher({ onThemeChange, activeTheme }: ThemeSwitcherProps) {
  const themes = [
    ...
    "theme-51", "theme-52", "theme-53", "theme-54", "theme-55",
         "theme-56", "theme-57", "theme-58", "theme-59", "theme-60", "theme-61", "theme-62", "theme-63", "theme-64", "theme-65", "theme-66", "theme-67", "theme-68", "theme-69", "theme-70", "theme-71", "theme-72"
  ];
